...
type
  ...
  public
    ...
    constructor Create(AModel: TtiObject; AView: TDateTimePicker; const AModelAttrib: string); reintroduce;
  end;
  ...
  public
    ...
    constructor Create(AModel: TtiObject; AView: TListView; const AModelAttrib: string); reintroduce;
  end;
...
begin
  ...
  gCtrlFactory.RegisterMapping(TDateTimePicker, TDateTimePickerController);
...
{ TVCLDateTimePickerController }

constructor TDateTimePickerController.Create(AModel: TtiObject;
  AView: TDateTimePicker; const AModelAttrib: string);
begin
  inherited Create(AModel, AView, AModelAttrib);
end;
...
begin
  View.DateTime := tiGetProperty(Model, FModelAttrib);
end;
...
function TDateTimePickerController.View: TDateTimePicker;
begin
  result := inherited View as TDateTimePicker;
end;

procedure TDateTimePickerController.ViewToModel;
begin
  tiSetProperty(Model, FModelAttrib, View.DateTime);
end;

{ TVCLListBoxController }
...
constructor TComboBoxController.Create(AModel: TtiObject;
...
{ TVCLListBoxIndexController }

constructor TListBoxIndexController.Create(AModel: TtiObject;
  AView: TListBox; const AModelAttrib: string);
begin
  inherited Create(AModel, AView, AModelAttrib);
...
begin
  lInteger := TypInfo.GetOrdProp(Model, FModelAttrib);
  View.ItemIndex := lInteger;
//  View.ItemIndex := Integer(tiGetProperty(Model, FModelAttrib));
end;
...
begin
  ...
  if not tiIsPublishedProp(AObject, lCol.ModelAttrib) then
    raise Exception.Create(lCol.ModelAttrib + ' is not part of the model');
...
constructor TListViewController.Create(AModel: TtiObject; AView: TListView;
  const AModelAttrib: string);
begin
  inherited Create(AModel, AView, AModelAttrib);
...
procedure TGridController.Update(ASubject: TtiObject; AOperation: TNotifyOperation);
begin
...
{ TVCLReadOnlyComboBoxController }
...
{ TVCLRadioGroupController }

constructor TRadioGroupController.Create(AModel: TtiObject;
  AView: TRadioGroup; const AModelAttrib: string);
begin
  inherited Create(AModel, AView, AModelAttrib);
end;
